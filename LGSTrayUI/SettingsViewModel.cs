...
public sealed partial class SettingsViewModel : ObservableObject
{
    ...
    private JsonObject BuildAppSettingsJson()
    {
        return new JsonObject
        {
            ...
            ["nativeDischargingPollPeriodSeconds"] = _appSettings.Native.DischargingPollPeriod,
            ["nativeChargingPollPeriodSeconds"] = _appSettings.Native.ChargingPollPeriod,
            ["nativeLowBatteryPollPeriodSeconds"] = _appSettings.Native.LowBatteryPollPeriod,
            ["nativeLowBatteryPollThresholdPercent"] = _appSettings.Native.LowBatteryPollThreshold,
