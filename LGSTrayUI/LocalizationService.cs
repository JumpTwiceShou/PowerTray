...
public sealed class LocalizationService : ObservableObject
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnUs = new Dictionary<string, string>
    {
        ...
        ["TrayToolTipDescription"] = "PowerTray custom hover may occasionally appear at the top-left of the screen on Windows 11 and fail to disappear. To avoid this behavior, choose Windows native hover or disable hover. Changes take effect after PowerTray restarts.",
    ...
    private static readonly IReadOnlyDictionary<string, string> ZhCn = new Dictionary<string, string>
    {
        ...
        ["TrayToolTipDescription"] = "PowerTray 自定义悬浮在 Windows 11 上可能偶发出现在屏幕左上角且无法自动消失。若要避免，请选择 Windows 原生悬浮或关闭悬浮。切换后需重启 PowerTray 生效。",
    ...
    private static readonly IReadOnlyDictionary<string, string> JaJp = new Dictionary<string, string>
    {
        ...
        ["TrayToolTipDescription"] = "PowerTray カスタム表示は、Windows 11 で画面左上に表示されたまま消えなくなる場合があります。この問題を避けるには、Windows ネイティブ表示を選択するか、ホバー表示を無効にしてください。変更は PowerTray の再起動後に反映されます。",
